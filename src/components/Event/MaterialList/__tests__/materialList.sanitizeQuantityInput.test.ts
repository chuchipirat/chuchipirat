/**
 * Unit-Tests für sanitizeQuantityInput (materialList.tsx).
 *
...
// materialList.tsx importiert transitiv davon (via pdfUtils.ts), obwohl
...
import {sanitizeQuantityInput} from "../materialList";
